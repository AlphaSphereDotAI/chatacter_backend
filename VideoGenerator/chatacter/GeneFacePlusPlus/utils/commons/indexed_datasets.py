...
class IndexedDataset:
    ...
    def __init__(self, path, unpickle=True):
        ...
        try:
            self.byte_offsets, self.id2pos, self.meta = load_index_data(
                self.root_data_file
            )
...
class IndexedDatasetBuilder:
    ...
    def __init__(
        ...
        path,
        append=False,
        max_size=1024 * 1024 * 1024 * 64,
        default_idx_size=1024 * 1024 * 16,
        gzip=False,
    ):
    ...
    def finalize(self):
        ...
        s = pickle.dumps(
            {"offsets": self.byte_offsets, "id2pos": self.id2pos, "meta": self.meta}
        )
