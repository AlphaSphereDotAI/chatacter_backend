...
from chatacter.sadtalker.src.facerender.modules.make_animation import make_animation
from chatacter.sadtalker.src.facerender.modules.mapping import MappingNet
